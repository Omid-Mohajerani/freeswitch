...
* [FreeSWITCH to VAPI SIP Integration For outgoing calls - Bring Your Own Trunk in VAPI](https://github.com/Omid-Mohajerani/freeswitch/blob/main/docs/vapi_freeswitch_carrier_routing.md)
